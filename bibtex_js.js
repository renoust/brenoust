...
function BibtexDisplay() {
  this.fixValue = function (value) {
      ...
      value = value.replace(/\\`o/g, '&ograve;')
      value = value.replace(/\\o/g, '&oslash;')
      value = value.replace(/\\c\{c\}/g, '&ccedil;')
      value = value.replace(/\\`a/g, '&agrave;')
      value = value.replace(/\\"a/g, '&auml;')
      value = value.replace(/\`\`/g, '"')
      value = value.replace(/\'\'/g, '"')
      value = value.replace(/\-\-/g, '-')
  ...
  this.displayBibtex = function(input, output, templateClass) {
    ...
    for (var entryKey in entries) {
      ...
      // find template
      var tpl = $("."+templateClass/*bibtex_template"*/).clone().removeClass(templateClass/*'bibtex_template'*/);
